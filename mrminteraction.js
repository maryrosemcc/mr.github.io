...
// if (hour > 6) { // testing dark mode during the day
  ...
  navigation[0].className = 'dark'; // bio
  navigation[1].className = 'dark'; // writing
  navigation[2].className = 'dark'; // moving image
  navigation[3].className = 'dark'; // clay
  navigation[4].className = 'dark'; // textiles
   navigation[5].className = 'dark'; // misc.
